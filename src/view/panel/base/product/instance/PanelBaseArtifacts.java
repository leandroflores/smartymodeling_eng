...
import controller.view.panel.base.product.instance.ControllerPanelBaseArtifacts;
 ...
 * @author Leandro
 * @since  2019-10-09
 * @see    controller.view.panel.base.product.instance.ControllerPanelBaseArtifacts
...
public final class PanelBaseArtifacts extends PanelBase {
    ...
    protected void addComponents() {
        ...
        this.add(this.createTextField("nameTextField", this.getInstance().getName(), 10), this.createConstraints(4, 1, 2, 1));
    ...
    public void setValues() {
        ...
        this.getElementsTextField().setText(Integer.toString(this.getViewNew().getElementsSize()));
        this.getAssociationsTextField().setText(Integer.toString(this.getViewNew().getAssociationsSize()));
