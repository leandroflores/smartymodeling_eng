...
/**
 * <p>Class of Controller <b>ControllerPanelBaseProduct_Final</b>.</p>
 * <p>Class responsible for controlling the <b>Events</b> from the <b>PanelBaseProduct_Final</b> of SMartyModeling.</p>
 * @author Leandro
 * @since  22/08/2019
 * @see    controller.view.ControllerPanel
 * @see    view.edit.panel.base.product.test.PanelBaseProduct_Final
 */
public class ControllerPanelBaseProduct_Final extends ControllerPanel {
    private final PanelBaseProduct_Final panelBaseProduct;

    /**
     * Default constructor method of Class.
     * @param panel Panel Base Product_Final.
     */
    public ControllerPanelBaseProduct_Final(PanelBaseProduct_Final panel) {
        super(panel);
