...
public class ControllerPanelBaseLifelineUML extends ControllerPanel {
    ...
    private void update() {
        ...
        this.panelBaseLifelineUML.getViewMenu().getPanelProject().getPanelTree().getPanelTreeDiagram().updateNode(this.panelBaseLifelineUML.getLifelineUML());
        ...
        this.panelBaseLifelineUML.getViewMenu().getPanelModeling().updateModelingPanels();
